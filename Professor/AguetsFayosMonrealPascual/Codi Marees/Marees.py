...
#CONSTANTS
m = [10,10,1]                   #llista de masses normalitzades
R = [5,5,1]                     #llista de radis de les masses
...
k_q = 500                      #coeficient de trasbalsament (moviment de marees d'un punt al següent)


#DISCRETITZACIÓ
T = 4500                        #nombre de Δt's
...
marc = 1.1*(R[0]+np.max(r))           #marc per al plot d'òrbita
...
step = 25               #interval entre cada temps j
